    ...
    Scaffold(
        ...
        Column(
            ...
            UserTaskCard(
                ...
                subtitle = "Create another Admin login",
                onClick = { navController.navigate("admin_add_admin") }
            )
            UserTaskCard(
...
@Composable
private fun UserTaskCard(icon: ImageVector, title: String, subtitle: String, onClick: () -> Unit) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
